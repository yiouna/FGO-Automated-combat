...
fgo_baojuweili_up = cv.imread('images/skill/fgo-baojuweili-up.png')
# 暴击伤害
...
fgo_lanka_up = cv.imread('images/skill/fgo-lanka-up.png')
# 无敌
fgo_wudi = cv.imread('images/skill/fgo-wudi.png')
# 回复
fgo_huifu = cv.imread('images/skill/fgo-huifu.png')
""" 游戏界面图标 """
